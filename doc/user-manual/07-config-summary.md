...
- **Render** — Lens Type, FOV, the camera's Elevation / Azimuth / Roll, Visible and Front, Resolution, EV and EV Anchor, Mode (screen / print), Show As (normal / channel_br, while Mode is Screen), and the ground colour — Sky Color under Screen, Paper Color under Print.
